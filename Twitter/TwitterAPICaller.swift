...
class TwitterAPICaller: BDBOAuth1SessionManager {    
    static let client = TwitterAPICaller(baseURL: URL(string: "https://api.twitter.com"), consumerKey: "viyQrx8g797yUq4xNjQe0Al7H", consumerSecret: "sP43C7fsdii5I9SsYQlozFmmek7DZuzlysqfXI9egqLeWHS67A")
    var loginSuccess: (() -> ())?
